...
const TopSection = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden md:flex flex-row items-center justify-between px-16 py-20 gap-12">
        {/* LEFT SIDE */}
        <div
          className="flex flex-col max-w-[600px] w-full gap-6 min-h-[500px]"
          style={{ minHeight: 500 }}
        >
          <div className="bg-surface flex items-center justify-center rounded-[16px] p-6 flex-1 min-h-0">
            <p
          ...
          <div className="flex items-center justify-center rounded-[16px] flex-1 min-h-0">
            <button className="bg-primary text-white font-bold text-xl py-4 px-6 rounded-[16px] hover:bg-primary/90 transition-colors w-full max-w-[350px] mx-auto">
