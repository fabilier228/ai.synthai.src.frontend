...
const Footer = () => {
  return (
    <>
      {/* Mobile footer */}
      <footer className="block md:hidden w-full bg-surface pt-2 pb-1 border-t-0">
      ...
      {/* Desktop footer */}
      <footer className="hidden md:flex flex-col w-full bg-surface pt-2 pb-1 border-t-0">
        <div className="mx-auto w-[60%]">
          <div className="flex justify-between text-text text-sm font-bold mb-0.5">
            <span>Home</span>
            <span>Home</span>
